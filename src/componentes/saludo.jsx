function Bienvenida({ nombre, apellido }) {
    return (
        <div className="mt-5 ml-5 relative">
            ...
            <h1 className="h-20 font-bold text-6xl relleno-letras text-center text-shadow-lg bg-[url('../src/assets/ele.png')] bg-[size:200px_auto] bg-[position:0%_15%]">Baby Shower</h1>
